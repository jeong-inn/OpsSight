...
def draw_box(ax, x, y, w, h, label, color="#1f77b4"):
...
draw_box(ax, 5, 8.5, 4, 0.7, "SECOM Sensor Data", "#2c3e50")
draw_box(ax, 5, 7.4, 4, 0.7, "Preprocessing", "#34495e")
arrow(ax, 7, 8.5, 7, 8.1)

draw_box(ax, 2.0, 6.1, 3.5, 0.8, "SPC Control Chart", "#1a5276")
draw_box(ax, 7.0, 6.1, 3.5, 0.8, "Isolation Forest", "#1a5276")
arrow(ax, 7, 7.4, 5.0, 6.9)
arrow(ax, 7, 7.4, 8.5, 6.9)

draw_box(ax, 5, 4.9, 4, 0.8, "Pre-failure Risk Scoring", "#6e2fa0")
arrow(ax, 8.5, 6.1, 7.5, 5.7)

draw_box(ax, 5, 3.7, 4, 0.8, "SHAP Feature Importance", "#0e6655")
...
draw_box(ax, 3.0, 1.0, 8, 0.9, "Streamlit Dashboard", "#17202a")
